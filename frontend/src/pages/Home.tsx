...
const Home = () => {
  ...
  return (
    ...
    <Box sx={{width:'100%', height:"100%", display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", padding: "0 20px 0 20px"}}>
      <Typography color="primary.light "variant="h2" align="center">Free Education For All</Typography>
      <Typography paddingBottom={"25px"}variant="h5" align="center">Using AI Tutoring with teacher leadership</Typography>
      <Button variant="contained" size="large" color="secondary" onClick={()=> navigate("/signup")}>Try It</Button>
    </Box>
