...
import { addMessage, generateChatCompletion, sendInitialChatRequest, getAIMessages, getTSMessages, sendUpdateClassroomMessage, ttsMessage, } from "../controllers/message-controller.js";
import { verifyToken } from "../utils/token-manager.js";
import { chatCompletionValidator, validate } from "../utils/validators.js";
const messageRouter = Router();
messageRouter.post("/", verifyToken, addMessage);
messageRouter.post("/new", validate(chatCompletionValidator), verifyToken, generateChatCompletion);
